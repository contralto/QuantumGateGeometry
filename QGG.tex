...
\begin{figure}[hb]
	\centering
	\def\xyz{1.0}
	\setlength\fboxsep{0pt}\fbox{\includegraphics[width=\xyz\columnwidth]{arrows.png}}
	\label{fig:sigcoll}
\end{figure} 
...
Nice rotation. Modified $R_X$. $P$ is the phase shift gate.

$$e^{i\theta/2}R_X(\theta)$$

$$HP(\theta)H$$

$$R_X(\pi/2)P(\theta)R_X(-\pi/2)$$
